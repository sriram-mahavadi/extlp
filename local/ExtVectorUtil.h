...
public:
    ...
    void store_dot_product(PackedVector& p_vct1, PackedVector& p_vct2, REAL& p_dot_product) {
        bool is_vct2_best_scatter = false;
        // Both vct1 and vct2 are packed. vct1 has greater sparsity than vct2.
        is_vct2_best_scatter = is_vct2_best_scatter || (p_vct1.get_sparsity() > p_vct2.get_sparsity());
