 ...
 * Author: sriram
 *
 * Created on 29 April, 2014, 11:04 AM
 */

#ifndef EXTSEQUENCE_H
#define	EXTSEQUENCE_H
 ...
 *                2014-2015 Sriram Mahavadi <sriram.mahavadi@gmail.com>
 *
...
class ExtSequence : private stxxl::noncopyable
{
public:
...
private:
    typedef stxxl::read_write_pool<block_type> pool_type;
    ...
    stxxl::unsigned_type m_alloc_count;
    ...
    stxxl::unsigned_type m_blocks2prefetch;
...
public:
    ...
    explicit ExtSequence(stxxl::int_type D = -1) :
        m_size(0),
        m_owns_pool(true),
        m_alloc_count(0),
        m_bm(stxxl::block_manager::get_instance())
    {
        if (D < 1) D = stxxl::config::get_instance()->disks_number();
    ...
    explicit ExtSequence(stxxl::unsigned_type w_pool_size, stxxl::unsigned_type p_pool_size, int blocks2prefetch = -1) :
        m_size(0),
        m_owns_pool(true),
        m_alloc_count(0),
