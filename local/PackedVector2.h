...
public:
    ...
    bool operator==(const PackedElement2& other) const{
...
private:
    ...
    LinkedList< PackedElement2<ItemClass> > m_vctPacked;
...
public:
    ...
    typedef typename LinkedList< PackedElement2<ItemClass> >::iterator llIterator_type;
    ...
    public:
        friend class PackedVector2<ItemClass>;
        iterator(){
        ...
        PackedElement2<ItemClass> operator*() {
            if(isPacked){
                return *itr;
            } else {
                PackedElement2<ItemClass> packedElement;
    ...
    PackedVector2(int p_realSize, ItemClass p_nullItem) {
    ...
    PackedVector2(int p_realSize, bool p_isPacked, ItemClass p_nullItem) {
        initializeDefaults(p_realSize, p_nullItem);
    ...
    PackedVector2(std::vector<ItemClass> &vct, ItemClass p_nullItem) {
...
//        DEBUG_MEMORY("After Deallocating Packed Linked List");
    ...
    void add(unsigned int index, ItemClass value, bool p_autoConversion=true) {
        ...
        if(isPacked()){
            PackedElement2<ItemClass> element;
